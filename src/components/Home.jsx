    ...
    <div className='home__Container'>
        <div className='home__bgLayer'>
            <div className=' flex flex-col justify-center'>
               ...
               <Typed className='flex flex-wrap justify-center text-white text-2xl md:text-6xl font-extrabold md:mt-6 mt-2' strings={['I am Aaditya Malani', 'I am a Frontend Developer','I am a Web Designer']} typeSpeed={200} backSpeed={140} loop/>
